...
- `OnCodeChange(addr common.Address, prevCodeHash common.Hash, prevCode []byte, codeHash common.Hash, code []byte)`: This hook is deprecated in favor of `OnCodeChangeV2` which includes a reason parameter ([#32525](https://github.com/bestyourwallet/go-ethereum/pull/32525)).

### New methods

- `OnCodeChangeV2(addr common.Address, prevCodeHash common.Hash, prevCode []byte, codeHash common.Hash, code []byte, reason CodeChangeReason)`: This hook is called when a code change occurs. It is a successor to `OnCodeChange` with an additional reason parameter ([#32525](https://github.com/bestyourwallet/go-ethereum/pull/32525)).

### New types

- `CodeChangeReason` is a new type used to provide a reason for code changes. It includes various reasons such as contract creation, genesis initialization, EIP-7702 authorization, self-destruct, and revert operations ([#32525](https://github.com/bestyourwallet/go-ethereum/pull/32525)).

## [v1.15.4](https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.15.4)

### Modified types

- `GasChangeReason` has been extended with auto-generated String() methods for better debugging and logging ([#31234](https://github.com/bestyourwallet/go-ethereum/pull/31234)).
- `NonceChangeReason` has been extended with auto-generated String() methods for better debugging and logging ([#31234](https://github.com/bestyourwallet/go-ethereum/pull/31234)).

## [v1.15.0](https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.15.0)
...
- `BlockEvent` has been modified:
  - The `TD` (Total Difficulty) field has been removed ([#30744](https://github.com/bestyourwallet/go-ethereum/pull/30744)).
...
## [v1.14.12](https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.12)
...
- `VMContext.StateDB` has been extended with the following method:
  - `GetTransientState(addr common.Address, slot common.Hash) common.Hash` method used to access contract transient storage ([#30531](https://github.com/bestyourwallet/go-ethereum/pull/30531)).
...
## [v1.14.10](https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.10)

### Modified types

- `OpContext` has been extended with the following method:
  - `ContractCode() []byte` provides access to the contract bytecode within the OpContext interface ([#30466](https://github.com/bestyourwallet/go-ethereum/pull/30466)).

## [v1.14.9](https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.9)
...
There has been a major breaking change in the tracing interface for custom native tracers. JS and built-in tracers are not affected by this change and tracing API methods may be used as before. This overhaul has been done as part of the new live tracing feature ([#29189](https://github.com/bestyourwallet/go-ethereum/pull/29189)). To learn more about live tracing please refer to the [docs](https://geth.ethereum.org/docs/developers/evm-tracing/live-tracing).
...
[unreleased]: https://github.com/bestyourwallet/go-ethereum/compare/v1.16.3...master
[v1.15.4]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.15.4
[v1.15.0]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.15.0
[v1.14.12]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.12
[v1.14.10]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.10
[v1.14.9]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.9
[v1.14.4]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.4
[v1.14.3]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.3
[v1.14.0]: https://github.com/bestyourwallet/go-ethereum/releases/tag/v1.14.0
